...
function validateLoginname() {
	 ...
	 */
	$.ajax({
		url:"/bookshop/user/regist/checkName",//要请求的url
...
function validateEmail() {
	 ...
	 */
	$.ajax({
		url:"/bookshop/user/regist/checkEmail",//要请求的servlet
...
function _hyz() {
	 ...
	 * 3. 使用毫秒来添加参数
	 */
	$("#imgVerifyCode").attr("src", "/bookshop/get/code?" + new Date().getTime());
}
