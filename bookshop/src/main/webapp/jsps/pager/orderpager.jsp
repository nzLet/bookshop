...
<script type="text/javascript">
	function _go() {
		...
		location = "/bookshop/front/order/list/" + pc;
	}
</script>
</head>
<body>
<div class="divBody">
	<div class="divContent">
		<a href="/bookshop/front/order/list/${pages.prePage }" class="aBtn bold">上一页</a>


		<c:forEach items="${pages.navigatepageNums}" var="pn">
			<a href="/bookshop/front/order/list/${pn}" class="aBtn">${pn }</a>
		</c:forEach>
		<c:if test="${pages.pageNum+2 < pages.pages }">
			<span class="spanApostrophe">...</span>
		</c:if>
		<a href="/bookshop/front/order/list/${pages.nextPage }" class="aBtn bold">下一页</a>
