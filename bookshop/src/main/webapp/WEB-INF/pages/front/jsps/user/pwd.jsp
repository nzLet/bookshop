...
<body>
	...
	<div class="div1">
		<form action="<c:url value='/user/updatePwd'/>" method="post"
			target="_top">
			<input type="hidden" name="method" value="updatePassword" />
			<table>
				<tr>
					<td><label class="error">${errorMsg }</label></td>
					<td colspan="2">&nbsp;</td>
				</tr>
				<tr>
					<td align="right">原密码:</td>
					<td><input class="input" type="password" name="loginpass"
						id="loginpass" value="" /></td>
				...
				<tr>
					...
					<td><input class="input" type="password" name="reloginpass"
						id="reloginpass" value="" /></td>
					<td><label id="reloginpassError" class="error"></label></td>
				</tr>
				<tr>
					<td align="right"></td>
					<td><img id="vCode" src="<c:url value='/get/code'/>"
