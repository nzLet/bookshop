...
<body>
	...
	<form action="<c:url value='/front/order/checkType'/>" method="post" id="form1"
		target="_top">
			...
			<div style="margin-left: 20px;">
				<div style="margin-bottom: 20px;">
					<input id="ICBC-NET-B2C" type="radio" name="yh"
						...
						align="middle" src="<c:url value='/bank_img/icbc.bmp'/>" /> <input
				...
				<div style="margin-bottom: 20px;">
					<input id="BCCB-NET-B2C" type="radio" name="yh"
						...
						id="NJCB-NET-B2C" type="radio" name="yh" value="NJCB-NET-B2C" /> <img
						name="NJCB-NET-B2C" align="middle"
				...
				<div style="margin-bottom: 20px;">
					...
					<img name="HKBEA-NET-B2C" align="middle"
						...
						id="NBCB-NET-B2C" type="radio" name="yh" value="NBCB-NET-B2C" /> <img
						name="NBCB-NET-B2C" align="middle"
				...
				<div style="margin-bottom: 20px;">
					...
					<img name="SDB-NET-B2C" align="middle"
						...
						src="<c:url value='/bank_img/gf.bmp'/>" /> <input id="SHB-NET-B2C"
						type="radio" name="yh" value="SHB-NET-B2C" /> <img
						name="SHB-NET-B2C" align="middle"
						src="<c:url value='/bank_img/sh.bmp'/>" /> <input
						id="SPDB-NET-B2C" type="radio" name="yh" value="SPDB-NET-B2C" /> <img
						name="SPDB-NET-B2C" align="middle"
